...
public class Programacion extends Materia implements Comparable<Materia>{
    private Set<Alumno> alumnosInscriptos;
    private Set<Profesor> profesoresInscriptos;
    public Programacion(Integer codigo, String nombre, Integer cantidadMaximaDeAlumnos, Date horario) {
        this.codigo = codigo;
        this.nombre = nombre;
