...
public class Fisica extends Materia implements Comparable<Materia>{
    private Set<Alumno> alumnosInscriptos;
    private Set<Profesor> profesoresInscriptos;
    public Fisica(Integer codigo, String nombre, Integer cantidadMaximaDeAlumnos, Date horario) {
        this.codigo = codigo;
        this.nombre = nombre;
