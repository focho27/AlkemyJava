...
public class Matematica extends Materia implements Comparable<Materia> {
    private Set<Profesor> profesoresInscriptos;
    private Set<Alumno> alumnosInscriptos;
    public Matematica(Integer codigo, String nombre, Integer cantidadMaximaDeAlumnos, Date horario) {
       this.codigo = codigo;
       this.nombre = nombre;
    ...
    public Set<Profesor> getProfesoresInscriptos() {
        return profesoresInscriptos;
    }

    public void setProfesoresInscriptos(Set<Profesor> profesoresInscriptos) {
